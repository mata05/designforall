...
Norman sieht den Ursprung von schlechten Design hauptsaechlich in einen Phaenomen, welches er in seinem Buch als Technologieparadoxon wie folgt beschreibt \cite[S.31]{don}:\\
...
Oder anders ausgedrueckt Systeme werden immer komplexer, da sie ueber im mehr Funktionalitaeten verfuegen, allerdings koennen diese aufgrund ihrer Anzahl nicht eindeutig abgebildet werden, was dazu fuehrt das Funktionen oft nur durch Kombination anderer Funktionen ausgefuehrt werden koennen. Durch Umstand erhoeht sich die Komplexitaet von Systemen immens. Zusätzlich dazu bekommt der Benutzer meist nur wenig Feedback, ob seine Interaktion mit dem System erfolgreich war. darauf wird gener zu Gunsten des Designs verzichtet. 
...
Norman erweiterete diese Defintionsbegriff um den der \textit{wahrgenomme} Affordanz. Darunter fallen auch suggierte Affordanzen, die gar nicht tatsaechich bestehen, wie beispielsweise aufgemalte Tueren durch die man nicht gehen kann oder der Computermonitor, der trotz seiner Begebenheiten nicht haptisch benutzbar ist. 
